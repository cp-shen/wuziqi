...
void initReplayGUI()
{
	...
	IMAGE title_replay, button_replay_1, button_finish_1, button_continue_1;
	...
	loadimage(&button_continue_1, L"button_continue_1.jpg");

	putimage(0, 0, &title_replay);
	putimage(0, 240, &button_continue_1);
...
int runReplayGUI()
{
	IMAGE  button_replay_1, button_replay_2, button_finish_1, button_finish_2, button_continue_1, button_continue_2;
	loadimage(&button_finish_1, L"button_finish_1.jpg");
	loadimage(&button_replay_1, L"button_replay_1.jpg");
	loadimage(&button_continue_1, L"button_continue_1.jpg");
	loadimage(&button_finish_2, L"button_finish_2.jpg");
	loadimage(&button_replay_2, L"button_replay_2.jpg");
	loadimage(&button_continue_2, L"button_continue_2.jpg");
	...
	while (1)
	{
		...
		{
			putimage(0, 240, &button_continue_2);
			if (mouse.uMsg == WM_LBUTTONUP)
				return CONTINUE;
		}
		else 
